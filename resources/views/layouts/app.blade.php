...
<head>
   ...
   <!-- =============== VENDOR STYLES ===============-->
   <!-- FONT AWESOME-->
   <link rel="stylesheet" href="{{ asset('asset/vendor/fontawesome/css/font-awesome.min.css') }}"/>
   <!-- SIMPLE LINE ICONS-->
   ...
   <!-- =============== PAGE VENDOR STYLES ===============-->
   <!-- WEATHER ICONS-->
   <link rel="stylesheet" href="{{ asset('asset/vendor/weather-icons/css/weather-icons.min.css') }}">
   <!-- =============== BOOTSTRAP STYLES ===============-->
...
<body>
   ...
   <!-- =============== VENDOR SCRIPTS ===============-->
   <!-- MODERNIZR-->
   <script src="{{ asset('asset/vendor/modernizr/modernizr.custom.js') }}"></script>
   <!-- MATCHMEDIA POLYFILL-->
   <script src="{{ asset('asset/vendor/matchMedia/matchMedia.js') }}"></script>
   <!-- JQUERY-->
   ...
   <!-- STORAGE API-->
   <script src="{{ asset('asset/vendor/jQuery-Storage-API/jquery.storageapi.js') }}"></script>
   <!-- JQUERY EASING-->
   <script src="{{ asset('asset/vendor/jquery.easing/js/jquery.easing.js') }}"></script>
   <!-- ANIMO-->
   <script src="{{ asset('asset/vendor/animo.js/animo.js') }}"></script>
   <!-- SLIMSCROLL-->
   <script src="{{ asset('asset/vendor/slimScroll/jquery.slimscroll.min.js') }}"></script>
   <!-- SCREENFULL-->
   <script src="{{ asset('asset/vendor/screenfull/dist/screenfull.js') }}"></script>
   <!-- LOCALIZE-->
   <script src="{{ asset('asset/vendor/jquery-localize-i18n/dist/jquery.localize.js') }}"></script>
   <!-- RTL demo-->
   <script src="{{ asset('asset/js/demo/demo-rtl.js') }}"></script>
   <!-- =============== PAGE VENDOR SCRIPTS ===============-->
   <!-- SPARKLINE-->
   <script src="{{ asset('asset/vendor/sparkline/index.js') }}"></script>
   <!-- FLOT CHART-->
   <script src="{{ asset('asset/vendor/Flot/jquery.flot.js') }}"></script>
   <script src="{{ asset('asset/vendor/flot.tooltip/js/jquery.flot.tooltip.min.js') }}"></script>
   <script src="{{ asset('asset/vendor/Flot/jquery.flot.resize.js') }}"></script>
   <script src="{{ asset('asset/vendor/Flot/jquery.flot.pie.js') }}"></script>
   <script src="{{ asset('asset/vendor/Flot/jquery.flot.time.js') }}"></script>
   <script src="{{ asset('asset/vendor/Flot/jquery.flot.categories.js') }}"></script>
   <script src="{{ asset('asset/vendor/flot-spline/js/jquery.flot.spline.min.js') }}"></script>
   <!-- CLASSY LOADER-->
   <script src="{{ asset('asset/vendor/jquery-classyloader/js/jquery.classyloader.min.js') }}"></script>
   <!-- MOMENT JS-->
   <script src="{{ asset('asset/vendor/moment/min/moment-with-locales.min.js') }}"></script>
   <!-- SKYCONS-->
   <script src="{{ asset('asset/vendor/skycons/skycons.js') }}"></script>
   <!-- DEMO-->
   <script src="{{ asset('asset/js/demo/demo-flot.js') }}"></script>
   <!-- VECTOR MAP-->
   <script src="{{ asset('asset/vendor/ika.jvectormap/jquery-jvectormap-1.2.2.min.js') }}"></script>
   <script src="{{ asset('asset/vendor/ika.jvectormap/jquery-jvectormap-world-mill-en.js') }}"></script>
   <script src="{{ asset('asset/vendor/ika.jvectormap/jquery-jvectormap-us-mill-en.js') }}"></script>
   <script src="{{ asset('asset/js/demo/demo-vector-map.js') }}"></script>
   <!-- =============== APP SCRIPTS ===============-->
